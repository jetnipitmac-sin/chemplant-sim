...
export function ProcessHeader() {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 border-b border-edge bg-panel/40 px-3 py-2 backdrop-blur sm:gap-x-4 sm:px-5 sm:py-2.5">
